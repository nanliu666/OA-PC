<template>
	<div class="fill">
		<page-header title="面试详情" show-back />
		<basic-container block>
			<!-- 头部 -->
			<div class="header">
				<div class="name-row">
					<div class="name-box">{{ InterviewInfo.name }}（{{ InterviewInfo.jobName }}）的面试</div>
					<div class="btn-box">
						<el-button type="primary" size="medium" @click="goToInterEdit">
							面试评价
						</el-button>
					</div>
				</div>
			...
			<!-- 面试评价 -->
			<div v-if="InterviewInfo.status !== 'UnEvaluate'" class="evaluate-wrap">
				<div class="title">
					面试评价
				</div>
				<div class="evaluate-detali">
					<div v-for="item in evaluateList" :key="item.name" class="evaluate-detali-item">
						<div class="label">
							{{ item.label }}
						</div>
						<div class="detail">
			...
			<div class="evaluate-wrap">
				...
				<div class="evaluate-detali">
					<div v-for="item in interviewList" :key="item.name" class="evaluate-detali-item">
						<div class="label">
							{{ item.label }}
						</div>
						<div class="detail">
			...
			<!-- 候选人信息 -->
			<person-detail :person-id="$route.query.id" @update="updatePersonData" />
		</basic-container>
	</div>
</template>
<script>
...
export default {
	...
	methods: {
		...
		updatePersonData(personData) {
			this.InterviewInfo.jobName = personData.jobName
		}
	}
}
</script>
