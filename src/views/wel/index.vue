      ...
      <el-col :span="24">
        <basic-container>
          <p style="text-align: center">
            <img
              src="https://img.shields.io/badge/Release-V2.5.0-green.svg"
              alt="Downloads"
            >
            <img
            ...
            >
            <img
              src="https://img.shields.io/badge/Spring%20Cloud-Greenwich.SR5-blue.svg"
              alt="Coverage Status"
            >
            <img
              src="https://img.shields.io/badge/Spring%20Boot-2.1.13.RELEASE-blue.svg"
              alt="Downloads"
            >
            <a
              target="_blank"
    ...
    <el-row>
      ...
      <el-col :span="8">
          ...
          <basic-container>
            <div class="el-font-size">
              ...
              <span><el-link
                ...
                target="_blank"
                type="primary"
              >https://sns.bladex.vip</el-link></span>
              <el-divider content-position="right">
                <i class="el-icon-star-off" />
              </el-divider>
              <span>获取文档</span>
        ...
        <el-row>
          <basic-container>
            <el-collapse
              v-model="logActiveNames"
              @change="handleChange"
            >
              <el-collapse-item
                title="2.5.0.RELEASE发布，增加岗位管理，增加用户导入导出"
                name="15"
              >
              ...
              <el-collapse-item
                title="2.3.1.RELEASE发布，流程增加租户定制，登陆增加验证码"
                name="13"
              >
                <div>1.新增登陆验证码功能</div>
              ...
              <el-collapse-item
                title="2.3.0.RELEASE发布，租户增强，底层架构插件全面增强"
                name="12"
              >
              ...
              <el-collapse-item
                title="2.2.1.RELEASE发布，集成ELK，增加分布式日志追踪"
                name="10"
              >
              ...
              <el-collapse-item
                title="2.2.0.RELEASE发布，增加集群监控，链路追踪"
                name="9"
              >
              ...
              <el-collapse-item
                title="2.1.0.RELEASE发布，全面增强底层驱动"
                name="8"
              >
              ...
              <el-collapse-item
                title="2.0.7.RELEASE发布，增加网关鉴权，强化代码生成"
                name="7"
              >
              ...
              <el-collapse-item
                title="2.0.6.RELEASE发布，兼容三大主流数据库"
                name="6"
              >
              ...
              <el-collapse-item
                title="2.0.5.RELEASE发布，升级分布式接口权限系统"
                name="5"
              >
              ...
              <el-collapse-item
                title="2.0.4.RELEASE发布，增加动态数据权限系统"
                name="4"
              >
              ...
              <el-collapse-item
                title="2.0.3.RELEASE发布，优化多租户oss系统，优化业务架构"
                name="3"
              >
              ...
              <el-collapse-item
                title="2.0.2.RELEASE发布，增加多租户oss管理系统"
                name="2"
              >
                <div>1.增加minio封装</div>
                <div>2.增加qiniu封装</div>
              ...
              <el-collapse-item
                title="2.0.0.RELEASE发布，完美定制的微服务开发平台"
                name="0"
              >
